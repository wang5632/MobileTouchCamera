...
namespace BitBenderGames {
  ...
  public class MobileTouchCameraEditor : CustomInspector {
    ...
    public void OnSceneGUI() {
      ...
      pBottomLeft = Handles.FreeMoveHandle(pBottomLeft, Quaternion.identity, handleSize, Vector3.one, Handles.SphereHandleCap);
      pTopRight = Handles.FreeMoveHandle(pTopRight, Quaternion.identity, handleSize, Vector3.one, Handles.SphereHandleCap);
      ...
      Vector3 pBottomRightNew = Handles.FreeMoveHandle(pBottomRight, Quaternion.identity, handleSize, Vector3.one, Handles.SphereHandleCap);
      Vector3 pTopLeftNew = Handles.FreeMoveHandle(pTopLeft, Quaternion.identity, handleSize, Vector3.one, Handles.SphereHandleCap);
